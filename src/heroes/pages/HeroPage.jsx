...
export const HeroPage = () => {
  ...
  return (
    <>
      ...
      >
        <img src={getHeroes.imagen} alt={getHeroes.nombre} className="w-full h-full rounded-l-2xl" />
        ...
        <div className="px-6 py-4">
          ...
          <span className="text-xl font-bold text-yellow-500">Descripcion:</span>
          <p className="text-gray-400 text-base text-justify mt-4 mb-4">{getHeroes.descripcion}</p>
